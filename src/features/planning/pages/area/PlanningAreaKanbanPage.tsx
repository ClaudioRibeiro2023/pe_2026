...
import { AreaPlansKanban } from '@/features/area-plans/pages/AreaPlansKanban'

export function PlanningAreaKanbanPage() {
  ...
  if (!area) {
    return (
      <div className="text-center py-12">
        ...
        <Button onClick={() => navigate('/planning/kanban')}>
